...
GANDENUM(SPEEDEE, 2, [NSNumber numberWithInt:2], @"beeaterHits", [NSNumber numberWithInt:10000], @"autoDestroyDelay", [NSNumber numberWithFloat:1.3f], @"slingerShootSpeedModifier", [NSNumber numberWithBool:TRUE], @"doesExpire")
GANDENUM(BOMBEE, 3, [NSNumber numberWithInt:1], @"beeaterHits", [NSNumber numberWithInt:180000], @"autoDestroyDelay", [NSNumber numberWithFloat:0.7f], @"slingerShootSpeedModifier", [NSNumber numberWithBool:FALSE], @"doesExpire")
