...
GANDENUM(BURNEE, 7, [NSNumber numberWithInt:0], @"beeaterHits", [NSNumber numberWithBool:FALSE], @"canBeReused", [NSNumber numberWithInt:15000], @"autoDestroyDelay", [NSNumber numberWithFloat:1.0f], @"slingerShootSpeedModifier", [NSNumber numberWithBool:TRUE], @"doesExpire", @"SlingerBurnee", @"shootSoundName", @"", @"freedSoundName")
...
GANDENUM(IRONBEE, 9, [NSNumber numberWithInt:0], @"beeaterHits", [NSNumber numberWithBool:FALSE], @"canBeReused", [NSNumber numberWithInt:180000], @"autoDestroyDelay", [NSNumber numberWithFloat:0.3f], @"slingerShootSpeedModifier", [NSNumber numberWithBool:FALSE], @"doesExpire", @"SlingerBee", @"shootSoundName", @"", @"freedSoundName")
