...
GANDENUM(Z_SHEET_SHARED,            10, [NSNumber numberWithInt:6], @"z")
GANDENUM(Z_BEES,                        11, [NSNumber numberWithInt:2], @"z")
GANDENUM(Z_SLINGER,                     12, [NSNumber numberWithInt:3], @"z")

GANDENUM(Z_BACKGROUND_FRONT,        13, [NSNumber numberWithInt:7], @"z")
